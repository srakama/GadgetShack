...
export default function TermsConditions() {
    return (
        <>
            <Head title="Terms & Conditions – GadgetShack" />
            <StorefrontLayout>
                <section className="mx-auto max-w-4xl px-4 py-12">
                    ...
                    <div className="mb-8">
                        <p className="text-gray-700 mb-4">
                            Welcome to GadgetShack. By accessing or using our website and purchasing our products,
                        ...
                        <p className="text-gray-700">
                            GadgetShack reserves the right to update or change these Terms &amp; Conditions at any time
                    ...
                    <div className="mb-8">
                        ...
                        <ul className="list-none space-y-2 text-gray-700">
                            <li><span className="font-medium">1.1</span> GadgetShack operates as an online retail store selling refurbished and new electronic devices within the Republic of South Africa.</li>
                    ...
                    <div className="mb-8">
                        ...
                        <ul className="list-none space-y-2 text-gray-700">
                            ...
                            <li><span className="font-medium">2.2</span> GadgetShack reserves the right to correct any pricing errors on the website. If an order is placed at an incorrect price, we will contact you before processing the order.</li>
                    ...
                    <div className="mb-8">
                        ...
                        <ul className="list-none space-y-2 text-gray-700">
                            ...
                            <li><span className="font-medium">3.3</span> GadgetShack uses secure, encrypted payment processing. We do not store card details on our servers.</li>
                        </ul>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <ul className="list-none space-y-2 text-gray-700">
                            ...
                            <li><span className="font-medium">4.3</span> GadgetShack is not liable for delays caused by circumstances beyond our reasonable control, including courier delays, load shedding, or public holidays.</li>
                        </ul>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700">
                            All products sold by GadgetShack are covered by a warranty of up to 2 years, as detailed
                    ...
                    <div className="mb-8">
                        ...
                        <ul className="list-none space-y-2 text-gray-700">
                            <li><span className="font-medium">7.1</span> All content on the GadgetShack website, including text, images, logos, and graphics, is the property of GadgetShack and is protected by applicable copyright and intellectual property laws.</li>
                    ...
                    <div className="mb-8">
                        ...
                        <ul className="list-none space-y-2 text-gray-700">
                            <li><span className="font-medium">8.1</span> GadgetShack's liability to you in connection with any order shall not exceed the purchase price paid for the relevant product.</li>
                    ...
                    <p className="text-gray-700 mt-10 pt-6 border-t border-gray-200 text-sm">
                        GadgetShack operates in accordance with the Consumer Protection Act (No. 68 of 2008),
