...
export default function SalePromotionsTerms() {
    return (
        <>
            <Head title="Sale & Promotions Terms – GadgetShack" />
            <StorefrontLayout>
                <section className="mx-auto max-w-4xl px-4 py-12">
                    ...
                    <div className="mb-8">
                        <p className="text-gray-700 mb-4">
                            ...
                            discounts, promotional offers, voucher codes, and special events conducted by GadgetShack
                    ...
                    <div className="mb-8">
                        ...
                        <ul className="list-disc list-inside space-y-2 text-gray-700">
                            ...
                            <li>GadgetShack reserves the right to limit the quantity of promotional items purchased per customer.</li>
                            <li>Promotions cannot be combined with other offers unless explicitly stated.</li>
                            <li>GadgetShack reserves the right to cancel, modify, or extend any promotion at any time without prior notice.</li>
                            <li>In the event of a pricing error, GadgetShack reserves the right to cancel the order and issue a full refund.</li>
                        </ul>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <ul className="list-none space-y-2 text-gray-700">
                            ...
                            <li><span className="font-medium">3.4</span> GadgetShack reserves the right to disable or invalidate any discount code that is suspected of misuse or fraud.</li>
                    ...
                    <div className="mb-8">
                        ...
                        <ul className="list-none space-y-2 text-gray-700">
                            ...
                            <li><span className="font-medium">4.4</span> GadgetShack will not be liable for any loss or inconvenience arising from stock availability during high-traffic sale events.</li>
                        </ul>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <ul className="list-none space-y-2 text-gray-700">
                            ...
                            <li><span className="font-medium">5.3</span> If any item within a bundle is out of stock, GadgetShack reserves the right to offer a substitute item of equal or greater value or cancel the bundle and issue a full refund.</li>
                        </ul>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <ul className="list-none space-y-2 text-gray-700">
                            ...
                            <li><span className="font-medium">6.3</span> If an order is partially returned, bringing the order value below the free delivery threshold, GadgetShack reserves the right to deduct the standard delivery fee from the refund.</li>
                        </ul>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <ul className="list-none space-y-2 text-gray-700">
                            ...
                            <li><span className="font-medium">7.3</span> GadgetShack reserves the right to modify or discontinue its loyalty programme at any time with reasonable notice to participants.</li>
                        </ul>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <ul className="list-none space-y-2 text-gray-700">
                            ...
                            <li><span className="font-medium">9.3</span> If a "buy X get Y free" or similar promotion applied to your order and you return the qualifying item, GadgetShack reserves the right to recover the value of any free item received.</li>
                        </ul>
                    </div>
                    ...
                    <div className="mb-8">
                        ...
                        <p className="text-gray-700">
                            While we take every effort to ensure promotional details are accurate, GadgetShack shall not
